...
class RecordContract extends Contract {
    ...
    */
    async issue(ctx, issuer, id, medName, mfgDate, expDate, mrp) {

        // create an instance of the paper
        let record = Record.createInstance(issuer, id, medName, mfgDate, expDate, parseInt(mrp));
