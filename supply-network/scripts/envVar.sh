...
export PEER0_DISTRIBUTOR_CA=${PWD}/organizations/peerOrganizations/distributor.example.com/peers/peer0.distributor.example.com/tls/ca.crt
...
setGlobalsCLI() {
  ...
  if [ "$USING_ORG" == "manufacturer" ]; then
    ...
    export CORE_PEER_ADDRESS=peer0.distributor.example.com:10051  
  elif [ $USING_ORG -eq 3 ]; then
