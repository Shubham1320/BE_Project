...
checkCommitReadiness manufacturer "\"ManufacturerMSP\": true" "\"RetailerMSP\": false" "\"DistributorMSP\": false"
checkCommitReadiness retailer "\"ManufacturerMSP\": true" "\"RetailerMSP\": false" "\"DistributorMSP\": false"
checkCommitReadiness distributor "\"ManufacturerMSP\": true" "\"RetailerMSP\": false" "\"DistributorMSP\": false"
...
checkCommitReadiness manufacturer "\"ManufacturerMSP\": true" "\"RetailerMSP\": true" "\"DistributorMSP\": false"
checkCommitReadiness retailer "\"ManufacturerMSP\": true" "\"RetailerMSP\": true" "\"DistributorMSP\": false"
checkCommitReadiness distributor "\"ManufacturerMSP\": true" "\"RetailerMSP\": true" "\"DistributorMSP\": false"

approveForMyOrg distributor

## check whether the chaincode definition is ready to be committed
## expect them both to have approved
checkCommitReadiness manufacturer "\"ManufacturerMSP\": true" "\"RetailerMSP\": true" "\"DistributorMSP\": true"
checkCommitReadiness retailer "\"ManufacturerMSP\": true" "\"RetailerMSP\": true" "\"DistributorMSP\": true"
checkCommitReadiness distributor "\"ManufacturerMSP\": true" "\"RetailerMSP\": true" "\"DistributorMSP\": true"

## now that we know for sure both orgs have approved, commit the definition
commitChaincodeDefinition manufacturer retailer distributor

## query on both orgs to see that the definition committed successfully
queryCommitted manufacturer
queryCommitted retailer
ueryCommitted distributor
...
if [ "$CC_INIT_FCN" = "NA" ]; then
  ...
  chaincodeInvokeInit manufacturer retailer distributor
fi
