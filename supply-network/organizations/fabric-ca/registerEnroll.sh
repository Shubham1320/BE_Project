...
function createDistributor() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@localhost:10054 --caname ca-distributor --tls.certfiles "${PWD}/organizations/fabric-ca/distributor/tls-cert.pem"
  { set +x; } 2>/dev/null

  echo 'NodeOUs:
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/localhost-10054-ca-distributor.pem
    OrganizationalUnitIdentifier: client
  PeerOUIdentifier:
    Certificate: cacerts/localhost-10054-ca-distributor.pem
    OrganizationalUnitIdentifier: peer
  ...
  infoln "Generating the peer0 msp"
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:10054 --caname ca-distributor -M "${PWD}/organizations/peerOrganizations/distributor.example.com/peers/peer0.distributor.example.com/msp" --csr.hosts peer0.distributor.example.com --tls.certfiles "${PWD}/organizations/fabric-ca/distributor/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the user msp"
  set -x
  fabric-ca-client enroll -u https://user1:user1pw@localhost:10054 --caname ca-distributor -M "${PWD}/organizations/peerOrganizations/distributor.example.com/users/User1@distributor.example.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/distributor/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the org admin msp"
  set -x
  fabric-ca-client enroll -u https://distributoradmin:distributoradminpw@localhost:10054 --caname ca-distributor -M "${PWD}/organizations/peerOrganizations/distributor.example.com/users/Admin@distributor.example.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/distributor/tls-cert.pem"
  { set +x; } 2>/dev/null
